...
const ProgramForm = () => {
    ...
    const { id } = useParams(); // Get program ID from URL for edit mode
    ...
    const fetchProgramData = async () => {
        ...
        try {
            const token = localStorage.getItem('adminToken');
            const res = await axios.get(`${API_BASE}/admin/programs/${id}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
            ...
            setFormData({
                universityId: program.universityId?._id || program.universityId || '',
                name: program.name || '',
                ...
                fee: program.fee || '',
                feePeriod: program.feePeriod || 'Total',
                description: program.description || '',
                eligibility: program.eligibility || '',
                image: program.image || '',
                brochureUrl: program.brochureUrl || '',
                youtubeUrl: program.youtubeUrl || '',
                syllabus: Array.isArray(program.syllabus)
                    ? program.syllabus.join(', ')
                    : program.syllabus || '',
                highlights: Array.isArray(program.highlights)
                    ? program.highlights.join(', ')
                    : program.highlights || '',
                careerOptions: Array.isArray(program.careerOptions)
                ...
                robots: program.robots || 'index, follow'
            });
        } catch (err) {
            ...
            if (err.response?.status === 401) {
                ...
                setError('Program not found. It may have been deleted.');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (isEditMode) {
                ...
                await axios.put(`${API_BASE}/admin/programs/${id}`, programData, {
                    headers: { Authorization: `Bearer ${token}` }
                });
            ...
            if (err.response?.status === 401) {
                ...
                setError(err.response?.data?.message || `Failed to ${isEditMode ? 'update' : 'create'} program. Please try again.`);
            }
            window.scrollTo({ top: 0, behavior: 'smooth' });
        } finally {
            setLoading(false);
            ...
            <div style={styles.wrapper}>
                ...
                <main style={styles.main}>
                    <div style={styles.loadingContainer}>
                        ...
                        <h2 style={{ color: '#334155', marginTop: '20px' }}>Loading Program Data...</h2>
                        <p style={{ color: '#64748B' }}>Please wait while we fetch the program details.</p>
                    </div>
                </main>
            </div>
        );
        ...
        <div style={styles.wrapper}>
            ...
            <aside style={styles.sidebar}>
                ...
                <nav style={styles.sidebarNav}>
                    ...
                    <Link href="/admin/universities/add" style={styles.navItem}>
                        <i className="fa-solid fa-building-columns"></i>
                        <span>Universities</span>
                    </Link>
                    <Link href="/admin/programs/add" style={styles.navItemActive}>
                        ...
                        <div style={styles.headerLeft}>
                            ...
                            <p style={styles.subtitle}>
                                {isEditMode
                                    ...
                                    : 'Create a new educational program for students'
                                }
                            </p>
                            {isEditMode && (
                                <div style={styles.editBadge}>
                                    <i className="fa-solid fa-edit"></i>
                                    Editing: {formData.name || 'Program'}
                                </div>
                            )}
                        </div>
                        <button
                                ...
                                <div style={styles.inputGroup}>
                                    ...
                                    {universities.length === 0 && !fetchingUni && (
                                        <small style={styles.errorHint}>
                                            No universities found. <Link href="/admin/universities/add" style={{ color: '#FF6B35' }}>Add one first</Link>
                                        </small>
                                    )}
                                </div>
                            ...
                            <div style={styles.grid}>
                                ...
                                <div style={styles.inputGroup}>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        placeholder="Program Name | University Name"
                                        style={styles.input}
                                        maxLength={60}
                                    />
                                    <small style={styles.hint}>{formData.metaTitle.length}/60 characters</small>
                                </div>
                                ...
                                <div style={{ ...styles.inputGroup, gridColumn: '1 / -1' }}>
                                    ...
                                    <textarea
                                        ...
                                        maxLength={160}
                                    ></textarea>
                                    <small style={styles.hint}>{formData.metaDescription.length}/160 characters</small>
                                </div>
                                ...
                                <div style={{ ...styles.inputGroup, gridColumn: '1 / -1' }}>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        placeholder="mba, online mba, business degree"
                                        style={styles.input}
                                    />
                                ...
                                <div style={styles.inputGroup}>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        placeholder="https://example.com/programs/slug"
                                        style={styles.input}
                                    />
                                </div>
...
const styles = {
    // ... All your existing styles plus these additions:
