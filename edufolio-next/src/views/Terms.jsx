    ...
    return (
        <div className="font-outfit bg-gray-50 min-h-screen flex flex-col">
            ...
            <div className="flex-grow container mx-auto px-4 py-12 max-w-4xl">
                <h1 className="text-3xl font-bold mb-8 text-gray-800">Terms & Conditions</h1>
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm space-y-6 text-gray-600 leading-relaxed">
                    ...
                    <p>
                        The Platform is owned by EDU FOLIO PRIVATE LIMITED, a company incorporated under the Companies Act, 1956 with its registered office at 6th floor, kandamkulathy towers, MG Road (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').
                    </p>
                    <p>
